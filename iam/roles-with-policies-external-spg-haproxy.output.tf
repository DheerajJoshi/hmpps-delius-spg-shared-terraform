...
# ECS
output "iam_role_haproxy_ext_ecs_role_arn" {
  value = "${module.create-iam-ecs-role-iso-ext.iamrole_arn}"
}

output "iam_role_haproxy_ext_ecs_role_name" {
  value = "${module.create-iam-ecs-role-iso-ext.iamrole_name}"
}

# APP ROLE
output "iam_policy_haproxy_ext_app_role_arn" {
  value = "${module.create-iam-app-role-iso-ext.iamrole_arn}"
}

output "iam_policy_haproxy_ext_app_role_name" {
  value = "${module.create-iam-app-role-iso-ext.iamrole_name}"
}

# PROFILE
output "iam_policy_haproxy_ext_app_instance_profile_name" {
